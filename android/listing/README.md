...
| Feature graphic, 1024x500 PNG with no alpha | [feature-graphic.png](feature-graphic.png), regenerated by `python3 scripts/make-icons.py` (needs `pillow` and `fonttools[woff]`) |
