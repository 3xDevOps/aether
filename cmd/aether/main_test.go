...
func TestDispatchHelp(t *testing.T) {
	...
	help := helpText()
	for _, name := range []string{"daemon", "version", "init", "link", "run", "attach", "runs", "pull", "setup", "workspace", "image", "member", "invite", "gui", "profile", "kill", "pause", "resume", "inject", "close", "relaunch", "inbox", "who", "handoff", "timeline", "cost", "budget", "template", "schedule", "protect", "unprotect"} {
