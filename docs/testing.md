...
| `terminal-geometry` | A newly launched cursor-addressed agent with a narrow writer and a wider desktop dashboard: the last-row/last-column marker stays correct through shared-grid growth, font zoom, returning to a mirror, and leaving/reopening the Terminal tab |
