...
When a worker reports or messages you, the server types an aether: line into
this terminal naming the command to run next. While waiting for workers, wait
with aether-internal inbox --wait 30 instead of polling worker list.
