...
import { alice, otherWorkspace, run, workspace } from '@/test/fixtures'
...
describe('command palette', () => {
  ...
  it('hides the admin surfaces behind the remote allowlist', async () => {
    ...
    // other admin methods are not on it, so their verbs never render. The
    // Workspaces command group is not one of them: switching scope is local.
    useStore.setState({
      capabilities: {
        gateway: 'remote',
