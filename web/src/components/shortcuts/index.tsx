        ...
        <Tooltip.Trigger<'button'>
          render={(triggerProps) => (
            <button
              ...
              className={cn(
                focusRing,
                'flex h-[22px] min-h-[22px] items-center gap-1 rounded-sm px-1.5 text-[12px] transition-colors hover:bg-toolbar-hover hover:text-foreground coarse:h-11 coarse:min-h-11 coarse:px-3',
              )}
            >
